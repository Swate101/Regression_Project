# Joseph Goerner
#Wrangle Zillow and the rest of Acquire and prepare still makeing seperate py files for both so yall will be happy
#Imports for functions that are needed for this project 
import numpy as np
import pandas as pd
...
#Connection function to access Codeup Database and retrieve zillow dataset from mysql using the required cradintials 
...
#wrangle: acquire and prep data set in the wrangle set 
def wrangle_zillow():
    '''
...
#Scale the information  with these functions
